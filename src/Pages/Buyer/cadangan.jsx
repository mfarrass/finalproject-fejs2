...
const HalamanProduct = () => {
  ...
  return (
    <div>
      <div className="container md:w-full md:flex md:px-56 md:mb-40">
        <div className="flex justify-center md:flex">
          <div className="w-fill h-[360px] -mb-20 md:mt-10">
            <img
              src="./casio.png"
              className="md:w-[600px] md:h-auto  rounded-2xl"
              alt=""
            />
          </div>
        </div>
              ...
              <div className="grid grid-rows-3 content-center mt-3">
                ...
                <div className="sm:invisible lg:visible lg:flex lg:flex-col lg:mt-5">
                  <button
                    ...
                    className={`w-[304px] h-[48px] rounded-xl self-center invisible md:visible ${
                      disableButton
      ...
      <button
        ...
        className="w-[328px] h-[48px] bg-purple-700 sticky -ml-2 left-50% translate-x-2/4 bottom-10 rounded-2xl text-white md:invisible"
      >
        Saya Tertarik dan Ingin Nego
      </button>
